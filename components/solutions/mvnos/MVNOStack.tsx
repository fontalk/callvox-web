...
import { Phone, MessageCircle, Smartphone, TrendingUp, Hash } from '@phosphor-icons/react';
import { ArrowRight } from '@phosphor-icons/react';

const services = [
  { num: 1, name: 'Voice termination', desc: 'Direct routes, premium CLI', icon: Phone },
  { num: 2, name: 'A2P SMS', desc: '98%+ delivery, 10DLC included', icon: MessageCircle },
  { num: 3, name: 'eSIM provisioning', desc: 'GSMA SGP.22/32, white-label RSP', icon: Smartphone },
  { num: 4, name: 'Airtime top-up', desc: '800+ operators, <3s delivery', icon: TrendingUp },
